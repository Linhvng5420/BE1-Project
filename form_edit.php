...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $manufacturerId = $productData['manu_id'];
        $typeId = $productData['type_id'];
        $description = $productData['description'];
        $price = $productData['price'];
        $feature = $productData['feature'];
        $imagePath = $productData['pro_image'];
    } else {
        echo "Error.";
    }
} else {
                            ...
                            <div class="widget-content nopadding">
                                ...
                                <form action="Edit_Product.php" method="POST"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span11"
                                                ...
                                                name="name"  value="<?php echo $productName; ?>" /> *
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">Image (Không Dấu):</label>
                                            <div class="controls">
                                                <input type="file"
                                                    name="fileUpload"
                                                    id="fileUpload">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number"
                                                        class="span11"
                                                        name="feature" value="<?php echo $feature; ?>"/> *
                                                </div>
                                            </div>
